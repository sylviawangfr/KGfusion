...
class PlattScalingBlender:
    ...
    def aggregate_scores(self):
        ...
        models_context = load_score_context(self.params['models'], in_dir=work_dir)
        ...
        save_to_file(str_re, work_dir + '_'.join(self.params['models']) + "_cali.log")
        print(str_re)
        return result
